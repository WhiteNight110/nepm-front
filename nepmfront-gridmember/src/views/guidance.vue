<template>
  <div>
    <div>
      ...
      <div id="panel"></div>
      <el-button type="primary" @click="gotoFeedbackInfo" style="width: 50%">
            返回
          </el-button>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...
    toDriving () {
      ...
      this.driving.search(
        new _this.mapModule.LngLat(guidanceStore.startLongitude, guidanceStore.startLatitude),
        new _this.mapModule.LngLat(guidanceStore.endLongitude, guidanceStore.endLatitude),
    ...
    gotoFeedbackInfo() {
      router.push("/feedbackInfo"); // Use the router object to navigate to the desired route
    }
  }
}
</script>
